...
__webpack_require__(72).config(); // Dependancies


const bodyParser = __webpack_require__(1);

const express = __webpack_require__(73);

const locationsDataMiddleware = __webpack_require__(122);

const methodOverride = __webpack_require__(146);

const path = __webpack_require__(7);

const serverless = __webpack_require__(154);

const app = express();
const router = express.Router(); // Template Settings

app.set("view engine", "ejs");
app.locals.rootPath =  true ? "/app/" : undefined; // Middleware
...
app.use(locationsDataMiddleware); // Routes

router.use(__webpack_require__(166));
...
var callSiteToString = __webpack_require__(3).callSiteToString
var eventListenerCount = __webpack_require__(3).eventListenerCount
...
lazyProperty(module.exports, 'callSiteToString', function callSiteToString () {
  ...
  return stack[0].toString ? toString : __webpack_require__(5)
})

lazyProperty(module.exports, 'eventListenerCount', function eventListenerCount () {
  return EventEmitter.listenerCount || __webpack_require__(6)
})
...
var typeis = __webpack_require__(58)
...
var toIdentifier = __webpack_require__(18)
...
var codes = __webpack_require__(14)
...
var iconv = __webpack_require__(29)
var onFinished = __webpack_require__(55)
...
var createError = __webpack_require__(11)
var iconv = __webpack_require__(29)
var unpipe = __webpack_require__(54)
...
var bomHandling = __webpack_require__(32),
...
iconv.getCodec = function getCodec(encoding) {
    if (!iconv.encodings)
        iconv.encodings = __webpack_require__(33); // Lazy load all encoding definitions.
...
if (nodeVer) {
    ...
    if (nodeVerArr[0] > 0 || nodeVerArr[1] >= 10) {
        __webpack_require__(51)(iconv);
    }

    // Load Node primitive extensions.
    __webpack_require__(53)(iconv);
}
...
var Buffer = __webpack_require__(31).Buffer,
    Transform = __webpack_require__(52).Transform;
...
var first = __webpack_require__(56)
...
var typer = __webpack_require__(59)
...
var proto = __webpack_require__(76);
var Route = __webpack_require__(83);
var Router = __webpack_require__(82);
var req = __webpack_require__(110);
var res = __webpack_require__(117);
...
exports.query = __webpack_require__(91);
exports.raw = bodyParser.raw
exports.static = __webpack_require__(121);
...
var finalhandler = __webpack_require__(77);
var Router = __webpack_require__(82);
var methods = __webpack_require__(87);
var middleware = __webpack_require__(90);
var query = __webpack_require__(91);
var debug = __webpack_require__(19)('express:application');
var View = __webpack_require__(92);
var http = __webpack_require__(88);
var compileETag = __webpack_require__(94).compileETag;
var compileQueryParser = __webpack_require__(94).compileQueryParser;
var compileTrust = __webpack_require__(94).compileTrust;
...
var encodeUrl = __webpack_require__(78)
var escapeHtml = __webpack_require__(79)
var onFinished = __webpack_require__(55)
...
function finalhandler (req, res, options) {
  ...
  // get environment
  var env = opts.env || "dev" || 'development'
...
var pathRegexp = __webpack_require__(86);
...
function View(name, options) {
  ...
  if (!opts.engines[this.ext]) {
    ...
    var fn = __webpack_require__(93)(mod).__express
...
var deprecate = __webpack_require__(2)('express');
var flatten = __webpack_require__(84);
var mime = __webpack_require__(97).mime;
var etag = __webpack_require__(99);
var proxyaddr = __webpack_require__(106);
var qs = __webpack_require__(66);
...
var destroy = __webpack_require__(98)
var encodeUrl = __webpack_require__(78)
var escapeHtml = __webpack_require__(79)
var etag = __webpack_require__(99)
var fresh = __webpack_require__(101)
var fs = __webpack_require__(25)
var mime = __webpack_require__(102)
var ms = __webpack_require__(104)
var onFinished = __webpack_require__(55)
...
var forwarded = __webpack_require__(107)
var ipaddr = __webpack_require__(108)
...
var accepts = __webpack_require__(111);
var deprecate = __webpack_require__(2)('express');
...
var Negotiator = __webpack_require__(112)
var mime = __webpack_require__(60)
...
var escapeHtml = __webpack_require__(79);
var http = __webpack_require__(88);
var isAbsolute = __webpack_require__(94).isAbsolute;
var onFinished = __webpack_require__(55);
var path = __webpack_require__(7);
var statuses = __webpack_require__(13)
var merge = __webpack_require__(89);
var sign = __webpack_require__(118).sign;
var normalizeType = __webpack_require__(94).normalizeType;
var normalizeTypes = __webpack_require__(94).normalizeTypes;
var setCharset = __webpack_require__(94).setCharset;
var cookie = __webpack_require__(119);
var send = __webpack_require__(97);
var extname = path.extname;
var mime = send.mime;
var resolve = path.resolve;
var vary = __webpack_require__(120);
...
const getLocationsData = __webpack_require__(123);
...
const fauna = __webpack_require__(124);
...
module.exports = async () => {
  const locations = await fClient.query(fQuery.Map(fQuery.Paginate(fQuery.Documents(fQuery.Collection("locations"))), fQuery.Lambda(x => fQuery.Get(x)))).catch(error => {
    // TODO: Need to track if this fails
    console.error(`Error:getLocationsData():`, error);
  });
  return locations.data.map(location => {
    return _objectSpread(_objectSpread({}, location.data), {}, {
      id: location.ref.id
    });
  });
};
...
module.exports = {
  Client: __webpack_require__(125),
  Expr: __webpack_require__(131),
  PageHelper: __webpack_require__(138),
  RequestResult: __webpack_require__(137),

  clientLogger: __webpack_require__(145),
  errors: __webpack_require__(127),
  values: __webpack_require__(133),
  query: __webpack_require__(128),
}
...
var btoa = __webpack_require__(126)
var errors = __webpack_require__(127)
var query = __webpack_require__(128)
var values = __webpack_require__(133)
var json = __webpack_require__(136)
var RequestResult = __webpack_require__(137)
var util = __webpack_require__(132)
var PageHelper = __webpack_require__(138)
...
function Client(options) {
  ...
  this._fetch = opts.fetch || __webpack_require__(142)
...
var annotate = __webpack_require__(129)
var deprecate = __webpack_require__(130)
var Expr = __webpack_require__(131)
var errors = __webpack_require__(127)
var values = __webpack_require__(133)
var objectAssign = __webpack_require__(135)
var util = __webpack_require__(132)
...
var nodeFetch = __webpack_require__(143)
...
/* harmony import */ var stream__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(52);
/* harmony import */ var http__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(88);
/* harmony import */ var url__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(81);
/* harmony import */ var https__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(144);
/* harmony import */ var zlib__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(57);
...
var debug = __webpack_require__(147)('method-override')
var methods = __webpack_require__(87)
var parseurl = __webpack_require__(80)
var querystring = __webpack_require__(71)
var vary = __webpack_require__(120)
...
try {
  var supportsColor = __webpack_require__(151);
...
const os = __webpack_require__(152);
const hasFlag = __webpack_require__(153);
...
const finish = __webpack_require__(155);
const getFramework = __webpack_require__(156);
const getProvider = __webpack_require__(158);
...
const aws = __webpack_require__(159);
...
const cleanUpEvent = __webpack_require__(160);

const createRequest = __webpack_require__(161);
const formatResponse = __webpack_require__(163);
...
const Request = __webpack_require__(162);
...
const isBinary = __webpack_require__(164);
const Response = __webpack_require__(157);
const sanitizeHeaders = __webpack_require__(165);
...
const ejs = __webpack_require__(167);

const indexTemplate = __webpack_require__(170);

const utils = __webpack_require__(171);
...
/** @type {string} */
var _VERSION_STRING = __webpack_require__(169).version;
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<!DOCTYPE html>\n<html lang=\"en_CA\">\n  <head>\n    <meta charset=\"utf-8\" />\n    <meta\n      name=\"viewport\"\n      content=\"width=device-width, initial-scale=1, viewport-fit=cover\"\n    />\n    <title>Location Ice Tracker</title>\n    <!-- link rel=\"stylesheet\" type=\"text/css\" href=\"<%= rootPath %>public/styles/global.css\" / -->\n  </head>\n\n  <body>\n    <div id=\"page-wrapper\">\n      <main role=\"main\">\n        <section class=\"bg-white\">\n          <% locationData.forEach(location => { %>\n          <h2>\n            <%= location.name %> | ~<%=\n            utils.iceThickness(location.history.map(date =>\n            date.temp.average))%>\"\n          </h2>\n          <ul>\n            <% location.history.forEach(date => { %>\n            <li>\n              <h4 class=\"date-day\" date=\"\"><%= date.date %></h4>\n              <p class=\"date-ice-freeze\">\n                ~<%= date.temp.average > 32 ?\n                `${utils.iceThaw(date.temp.average)} Ice Thaw` :\n                `${utils.iceFreeze(date.temp.average)} Ice Freeze` %>\"\n              </p>\n              <p class=\"date-temp\">\n                <span>Daily Temp</span><br /><span class=\"date-temp-high\"\n                  ><%= date.temp.high.toFixed() %>&deg;</span\n                >\n                |\n                <span class=\"date-tempw-low\"\n                  ><%= date.temp.low.toFixed() %>&deg;</span\n                >\n              </p>\n            </li>\n            <% }); %>\n          </ul>\n          <% }); %>\n        </section>\n        <div class=\"footer\">&copy; <%= utils.currentYear %> Chris Pond</div>\n      </main>\n    </div>\n    <!-- script src=\"<%= rootPath %>public/scripts/global.js\"></script -->\n  </body>\n</html>\n");
...
const calcThickness = temps => {
  return temps.reduce((accumulator, currentValue) => {
    ...
    const amountOfFreeze = isFreezing ? calcFreeze(currentValue) : -calcThaw(currentValue);
